...
def generate_launch_description():
    return LaunchDescription([
        ...
        # NOTE: To disable static_transform_publisher when we integrate the 
        # Lidar module with a robot, as base_laser with be dynamically related to
        # the base_link of the robot
