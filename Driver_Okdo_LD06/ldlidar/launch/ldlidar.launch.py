...
def generate_launch_description():
    return LaunchDescription([
        ...
        # NOTE: We should disable the static transform publisher when integrating the Lidar module
        # with a physical robot, as the base_laser link will be attached to the robot body.
        Node(
            package='tf2_ros',
